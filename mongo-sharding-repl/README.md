...
MongoDB с шардированием (2 шарда) и репликацией (3 реплики на каждый шард) для приложения «Мобильный мир».
...
Убедитесь, что все 13 сервисов в статусе `running`.
