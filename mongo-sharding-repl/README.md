...
Шардирование MongoDB с двумя шардами и репликацией (по 3 реплики на шард) для проекта «Мобильный мир».
...
Shard 1 (Replica Set)     Shard 2 (Replica Set)
  ...
  - shard1-2:270182         - shard2-2:270202
  - shard1-3:270183         - shard2-3:270203
```
...
Все 10 контейнеров должны быть в статусе Up или running.
...
Должно показать: один PRIMARY и два SECONDARY.
...
echo "=== Инициализация MongoDB Sharding with Replication ==="
...
```powershell
Write-Host "=== Инициализация MongoDB Sharding with Replication ===" -ForegroundColor Green
