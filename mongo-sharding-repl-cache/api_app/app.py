import json
import logging
import logging.config  # Добавьте эту строку!
import os
import time
...
logging.config.dictConfig(logging_config)  # Теперь это работает
...
async def root():
    ...
    return {
        ...
        "mongo_nodes": str(client.nodes),
        "mongo_primary_host": str(client.primary),
        "mongo_secondary_hosts": str(client.secondaries),
