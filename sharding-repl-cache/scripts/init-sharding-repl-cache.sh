...
echo ">>> Готово! Шардирование с репликацией и кешированием настроено."
echo ">>> Проверьте кеширование: вызовите GET http://localhost:8080/helloDoc/users дважды."
echo ">>> Второй вызов должен выполниться значительно быстрее (<100мс)."
