...
# --- In-memory log buffer (to view logs in browser) ---
LOG_BUFFER_MAX = int(os.getenv("LOG_BUFFER_MAX", "500"))
...
# attach to root + your module logger
