...
|  Отображение статуса заказа  |          нет          |           да           |          менее минуты          | Как правило, пользователь хочет убедиться, что заказ был оплачен; задержка репликации не должна быть дольше характерного времени проведения оплаты                                |
|                              |                       |                        |                                |                                                                                                                                                                                   |
